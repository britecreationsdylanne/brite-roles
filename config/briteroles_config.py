...
AI_PROMPTS = {
    "generate_jd": (
        ...
        "CRITICAL RULES:\n"
        "- You MUST use the EXACT title '{title}' in the description — do NOT substitute a different title\n"
        "- You MUST reference the EXACT department '{department}' — do NOT use a different department name\n"
        "- You MUST match the work type: if hybrid say hybrid, if remote say remote, if on-site say on-site\n"
        "- You MUST match the location specified above — do NOT invent a different location\n"
        ...
        "EXAMPLES OF PAST BRITECO JOB DESCRIPTIONS (match this voice and specificity, NOT the content):\n\n"
        "---\n"
    ...
    "adapt_jd": (
        ...
        "{notes}\n\n"
        "INSTRUCTIONS:\n"
        "- You MUST use the EXACT title '{title}' — do NOT substitute a different title\n"
        "- You MUST reference the EXACT department '{department}' — do NOT use a different department name\n"
        "- You MUST match the work type and location specified above\n"
